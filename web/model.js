 ...
 *
 *  market — лучшая цена риска по рынку опционов. Единственный критерий, не
 *           требующий ваших предпочтений: сравнивается премия оферты с ценой
 *           опциона на тот же риск с той же датой экспирации.
